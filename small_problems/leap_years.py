...
# For simplicity, this exercise assumes that the Gregorian calendar has been in continuous use
# since since the year 1. We'll address that assumption in the next exercise that follows this one.
