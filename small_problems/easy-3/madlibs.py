...
# then construct a list of words and place them into the story, creating an often silly or funny story
# as a result.
...
print(f'''
      ...
      The {verb} {adverb} {verb}s up to Joe's {adjective} turtle.
      ''')
# Example
# Enter a noun: dog
# Enter a verb: walk
