...
# 4. Given a list of numbers [1, 2, 3, 4, 5], mutate the list by removing the number at index 2,
...
# 5. How would you verify whether the data structures assigned to the variables numbers and table
# are of type list?
numbers = [1, 2, 3, 4]
